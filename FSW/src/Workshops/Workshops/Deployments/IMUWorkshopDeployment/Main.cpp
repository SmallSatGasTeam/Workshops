...
#include <Workshops/Deployments/IMUWorkshopDeployment/Top/IMUWorkshopDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Deployments::startRateGroups();
    Deployments::teardownTopology(inputs);
