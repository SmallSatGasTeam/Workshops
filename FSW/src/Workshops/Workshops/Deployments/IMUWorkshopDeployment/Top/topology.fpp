module Deployments {
  ...
  deployment topology IMUWorkshopDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "IMUWorkshopDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections IMUWorkshopDeployment {
      IMUWorkshop.i2cWrite -> i2cLinuxDriver.write
      IMUWorkshop.i2cWriteRead -> i2cLinuxDriver.writeRead
      IMUWorkshop.allocate -> ComCcsds.commsBufferManager.bufferGetCallee
      IMUWorkshop.deallocate -> ComCcsds.commsBufferManager.bufferSendIn
      rateGroup_1Hz.RateGroupMemberOut[6] -> IMUWorkshop.schedIn
